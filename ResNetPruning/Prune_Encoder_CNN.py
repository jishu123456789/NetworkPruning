...
if __name__ == "__main__":
    ...
    images_path = r"C:\Users\jishu\Documents\Changwon\ImageCaptioningTrial\Image-Captioning-with-Transformers-main\flickr8k\Images"
    caption_path = r"C:\Users\jishu\Documents\Changwon\ImageCaptioningTrial\Image-Captioning-with-Transformers-main\flickr8k\captions.txt"
    
    # Also load the TinyImageNet dataset
    tiny_imagenet_path = r"data\\Images\\"
    ...
    for i in range(iterative_steps):
        ...
        for epoch_ft in range(fine_tune_epochs):
            fine_tune_loader_ft_iter = tqdm(fine_tune_loader, desc=f'Fine-tuning Epoch {epoch_ft + 1}/{fine_tune_epochs}', leave=False)
            for images, _ in fine_tune_loader_ft_iter:
                images = images.to(device)
    ...
    torch.save(pruned_model.state_dict(), os.path.join(save_dir, 'fine_tuned_model.pth'))
